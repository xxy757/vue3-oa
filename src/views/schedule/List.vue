      ...
      <template v-if="currentSchedule">
        <n-descriptions :column="1" label-placement="left">
          ...
          <n-descriptions-item label="优先级">
            <n-tag :color="{ color: getPriorityColor(currentSchedule.priority), textColor: '#fff' }">
          ...
          <n-descriptions-item label="时间">
            ...
            <template v-else>
              {{ currentSchedule.startDate }} {{ currentSchedule.startTime }} - {{ currentSchedule.endTime }}
            </template>
          </n-descriptions-item>
...
import { AddOutline, TimeOutline, LocationOutline, CreateOutline, TrashOutline, EyeOutline } from '@vicons/ionicons5'
