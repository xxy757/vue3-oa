...
const deptTreeOptions = computed(() => {
  const buildOptions = (items: Dept[], parentId: number | null = null, excludeId?: number): Dept[] => {
    return items
  ...
  return buildOptions(deptList.value, null, isEdit.value ? formData.id : undefined)
})
